...
async function abrirModalEdicao(idFuncionario) {
    try {
        ...
        const resposta = await fetch(`${URL_GERENCIAR_FUNCIONARIO}/listar?idFuncionario=${idFuncionario}`);
...
async function confirmarExclusao() {
    ...
    try {
        ...
        const resposta = await fetch(`${URL_GERENCIAR_FUNCIONARIO}/deletar?idFuncionario=${idFuncionario}`);
