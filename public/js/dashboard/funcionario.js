...
function verificarPermissoes() {
  console.log('NIVEL_ACESSO:', sessionStorage.NIVEL_ACESSO);
  console.log(sessionStorage.ID_FUNCIONARIO);
  console.log(sessionStorage.NOME_FUNCIONARIO);
  console.log(sessionStorage.EMAIL_FUNCIONARIO);
...
function validarCampos() {
  ...
  if (senha !== '') {
    let senhaForte = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^A-Za-z0-9]).{8,}$/;
