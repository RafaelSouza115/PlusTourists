...
function dadosKpiTuristas(req, res) {
  ...
  dashboardModel
    .buscarDadosKpiTuristas(filtros.ano, filtros.idEstado)
...
function mesesMenosTuristas(req, res) {
  ...
  dashboardModel
    .buscarMesesMenosTuristas(filtros.ano, filtros.idEstado)
    .then((resultado) => {
      res.status(200).json({
...
function mesTopComEvento(req, res) {
  ...
  dashboardModel
    .buscarMesTopComEvento(filtros.ano, filtros.idEstado)
    .then((resultado) => res.status(200).json(primeiroRegistro(resultado)))
...
function principalViaAcesso(req, res) {
  ...
  dashboardModel
    .buscarPrincipalViaAcesso(filtros.ano, filtros.idEstado)
    .then((resultado) => res.status(200).json(primeiroRegistro(resultado)))
...
function eventosTuristasPorMes(req, res) {
  ...
  dashboardModel
    .buscarEventosTuristasPorMes(filtros.ano, filtros.idEstado)
...
function turistasPorViaAcesso(req, res) {
  ...
  dashboardModel
    .buscarTuristasPorViaAcesso(filtros.ano, filtros.idEstado)
    .then((resultado) => {
      var totais = {
        aerea: 0,
        terrestre: 0,
...
function top5PaisesCompleto(req, res) {
  ...
  dashboardModel
    .buscarTop5PaisesCompleto(filtros.ano, filtros.idEstado)
    .then((paises) => {
