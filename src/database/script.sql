...
DROP TABLE IF EXISTS plano_turistico;
DROP TABLE IF EXISTS locall;
DROP TABLE IF EXISTS tipo_transporte;
DROP TABLE IF EXISTS pais_origem;
DROP TABLE IF EXISTS status_plano;
...
INSERT INTO funcionario (nome, cpf, email, senha, nivel_acesso, id_empresa)
VALUES (
    'Funcionario Padrao',
    '00000000000',
